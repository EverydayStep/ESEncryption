#
#  Be sure to run `pod spec lint ESEncryption.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/EverydayStep/ESEncryption.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ESEncryption/ESEncryption/*.{h,m}"
